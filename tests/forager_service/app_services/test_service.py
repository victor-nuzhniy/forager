...
class TestServiceDomainSearch(object):
    ...
    @patch('forager_service.app_clients.client.Client._perform_request')
    def test_domain_search(
        ...
        ClientInitializer().initialize_service(api_key)
...
class TestServiceEmailFinder(object):
    ...
    def test_email_finder(
        ...
        ClientInitializer().initialize_service('some_api_key')
        mock_request.side_effect = get_query
